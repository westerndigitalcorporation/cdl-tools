...
plot baseline using 1:9 with lp title "Baseline" lc rgb"blue", \
     ...
     filename index 3 using 1:9 with lp title columnheader(1) lc rgb"green", \
     filename index 4 using 1:9 with lp title columnheader(1) lc rgb"magenta", \
     filename index 5 using 1:9 with lp title columnheader(1) lc rgb"cyan"
