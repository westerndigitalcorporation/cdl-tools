...
testname="Counter values (inactive time limit, policy 0x0, A:B=1:2)"
...
# Using policy 0x0, we should not see any change
# in the statistics counters.
read_limits="stats-inactive-time"
write_limits=""
cdl_dld=1
expect_error=0
compare_latencies=0
ncq=1
rw="randread"
stats="ATA-stats-inactive-time.cfg"
